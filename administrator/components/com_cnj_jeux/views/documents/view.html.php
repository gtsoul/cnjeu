 ...
 * @since       1.6
 */
class Cnj_jeuxViewDocuments extends JView
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CNJ_JEUX_MANAGER_DOCUMENTS'), 'jeux.png');
                ...
                if ($canDo->get('core.edit.state'))
		{
                        ...
                        JToolBarHelper::deleteList('Etes-vous sur de vouloir supprimer ?', 'documents.delete');
		}
	}
}
