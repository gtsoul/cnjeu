...
</td><td><h2><?php echo JText::_('RESOLVE_CONLFICTS'); ?></h2></td></tr></table><br/>
<br/>
...
foreach ($this->synclog as $i => $details) {
    ...
    </td><td><?php echo $error['user']['jname'] . ': ' . $error['user']['userinfo']->userid . ' / ' . $error['user']['userlist']->username . ' / ' . $error['user']['userlist']->email;
    /**
