...
foreach ($this->rows as $record) {
    ...
    if ($record->time_end) { ?>
        ...
        <td><?php echo getFormattedTimediff($record->time_start, $record->time_end); ?></td>
        <?php
    } else { ?>
        <td></td>
    ...
    <td><a class="modal" rel="{handler: 'iframe', size: {x: 650, y: 375}}" href="index.php?option=com_jfusion&amp;task=syncstatus&amp;tmpl=component&amp;syncid=<?php echo $record->syncid; ?>"><?php echo JText::_('CLICK_FOR_MORE_DETAILS'); ?></a></td></tr>
    <?php
}
?>
