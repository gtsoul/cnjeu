...
<img src="components/com_jfusion/images/login_checker.png" height="75px" width="75px"></td>
<td><h2><?php echo JText::_('LOGIN_CHECKER'); ?></h2></td></tr></table><br/>

<font size="2"><?php echo JText::_('LOGIN_CHECKER_TEXT'); ?></font>
<br/><br/>
<table class="adminlist" style="border-spacing:1px;"><thead><tr><th colspan="2" class="title" >
<?php echo JText::_('LOGIN_CHECKER'); ?>
</th></thead><tr><td width="200px">
