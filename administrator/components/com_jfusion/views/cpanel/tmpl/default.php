...
<div id="cpanel">
    ...
    <div style="float:left;">
            <div class="icon">
                ...
                <img src="components/com_jfusion/images/documentation.png" height="50px" width="50px">
...
if ($plugin_user && $plugin_auth) {
    ?>
    <table style="background-color:#d9f9e2;width:100%;"><tr><td width="50px"><td>
    ...
    ?>
    <table style="background-color:#f9ded9;width:100%;"><tr><td width="50px"><td>
