...
class JFormFieldiCmap_lng extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html.= '<label class="icmap-label">'.JText::_('COM_ICAGENDA_GOOGLE_MAPS_LONGITUDE_LBL').'</label> <input name="'.$this->name.'" id="lng" type="text" size="41" style="color:#777777;" value="'.$def.'"/>';
