...
if(version_compare(JVERSION, '3.0', 'lt')) {
	...
	$icPanCategory=JText::_('COM_ICAGENDA_TITLE_EVENT');
...
<form action="<?php echo JRoute::_('index.php?option=com_icagenda&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="category-form" class="form-validate">
	<div class="container">
		...
		<!-- iCagenda Header -->
		<header>
			<h1><?php echo empty($this->item->id) ? JText::_('COM_ICAGENDA_LEGEND_NEW_CATEGORY') : JText::sprintf('COM_ICAGENDA_LEGEND_EDIT_CATEGORY', $this->item->id); ?> <span>iCagenda</span></h1>
			<h2>
