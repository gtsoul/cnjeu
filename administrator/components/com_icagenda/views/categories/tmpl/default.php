...
<?php endif;?>
	...
	<?php endif; ?>
			...
			<thead>
				<tr>
<!-- Ordering HEADER Joomla 3.x (Not in used currently) -->
...
<!-- Ordering Joomla 3.x (Not in used currently) -->
	<?php if(version_compare(JVERSION, '3.0', 'ge')) : ?>
...
<!-- Color -->
					<td class="small hidden-phone">
						<div style="display:block; witdh:50px; height:40px; border-radius:5px; background:<?php echo $item->color; ?>;"></div>
					</td>
