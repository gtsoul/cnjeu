...
//							foreach ($getUpdatestatus AS $status)
							...
							echo '<div class="span3" style="padding: 10px; margin:10px 20px 10px 0px; background: #D9D9D9; border-radius:10px;">';
								...
								{
									$img	= '<img width=280px height=160px src="'.$thumb.'">';
								...
								if ($authorWebsite != NULL) {
									echo '<div>'.JText::_('COM_ICAGENDA_THEME_AUTHOR_WEBSITE').' : <a href="'.$authorUrl->firstChild->nodeValue.'" target="_blanck">' . $authorWebsite . '</a></div>';
								}
								...
								echo '<p></p><div style="display:block; margin-left:auto; margin-right: auto;">';
									...
									if (($updateVersion > $version->firstChild->nodeValue) && ($updateVersion != $unknown)) {
										echo '<a href="'.$updateDownload.'" target="_blanck"><div class="btn_update">'.JText::_('COM_ICAGENDA_THEME_UPDATE').' ' . $updateVersion . ' !</div></a>';
			...
			<div class="span12" style="margin-left: 0px">
				<div class="span6">
					<div>
						<a href="http://www.joomlic.com/translations" target="_blanck" class="btn"><?php echo JText::_('COM_ICAGENDA_PANEL_TRANSLATION_PACKS_DONWLOAD');?></a>
						<a href='http://www.joomlic.com/forum/icagenda'  target="_blanck" class="btn"><?php echo JText::_('COM_ICAGENDA_PANEL_HELP_FORUM'); ?></a>
					</div>
				</div>
				<div class="span6">
				</div>
	...
	<div class="row-fluid">
		...
		<hr>
			...
			<div class="span3" style="text-align: right">
				<a href='http://www.joomlic.com' target='_blanck'><img src="../media/com_icagenda/images/logo_joomlic.png" border="0"/></a>
				<br />
