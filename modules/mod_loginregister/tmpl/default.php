...
<h3>Bienvenu dans l'espace Presse/Pro : </h3>
...
<?php if ($params->get('greeting')) : ?>
	...
	<?php if($params->get('name') == 0) : {
		echo "<p>Vous &ecirc;tes actuellement connect&eacute; entant que ".$user->get('name')."</p>";
		echo '<p>Vous pouvez acc&egrave;der à l\'<a href="'.JURI::base().'index.php?option=com_content&view=article&id=67&Itemid=188" style="font-family: verdana; color: rgb(0, 0, 0); text-decoration: underline;">Espace Presse Pro</a></p>';
	} else : {
		echo "<p>vous &ecirc;tes actuellement connect&eacute; entant que ".$user->get('username')."</p>";
				echo '<p>Vous pouvez acc&egrave;der à l\'<a href="'.JURI::base().'index.php?option=com_content&view=article&id=67&Itemid=188" style="font-family: verdana; color: rgb(0, 0, 0); text-decoration: underline;">Espace Presse Pro</a></p>';
	} endif; ?>
	</div>
<?php endif; ?>
	<div class="logout-button">
		<input type="submit" name="Submit" class="button" value="se d&eacute;connecter" />
...
<span style="font-family:Abel;font-style:normal;font-weight:400;font-size:36px;text-transform:uppercase;">
<?php echo $params->get('pretext');?></span>
...
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="loginregister" id="login-form" >
	...
	<!--<ul>
		...
		<li>
			...
			<?php echo JText::_('MOD_LOGINREGISTER_FORGOT_YOUR_USERNAME'); ?></a>
		</li>
...
<p>Si vous n'avez pas d'identifiant pour acc&eacute;der, vous pouvez <a href="<?php echo JURI::base(); ?>index.php?option=com_alfcontact&view=alfcontact&Itemid=177" style="font-family: verdana; color: rgb(0, 0, 0); text-decoration: underline;">nous contacter</a></p>
