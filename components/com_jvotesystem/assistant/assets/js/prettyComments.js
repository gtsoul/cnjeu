...
(function($){// wrapping function + all "jQuery" calls replaced by "$" //The jVoteSystemTeam
	$.fn.prettyComments = function(settings) {
		...
		var expand = function(which){
			if(settings.animate && !settings.alreadyAnimated){
				...
				$(which).animate({'height':($("#comment_hidden").height() + 10)},settings.animationSpeed,function(){
