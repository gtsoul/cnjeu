...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post" class="item-page">

	<h2><?php echo JText::_('COM_SEARCH_FOR'); ?> <?php echo $this->escape($this->origkeyword); ?></h2>	
