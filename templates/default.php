    ...
    <table>
        ...
        <tr>
      	...
      	<tr>
    		...
    		<td><input class="" name="name" id="name" type="text" size="30" value="Votre téléphone"/></td>
        </tr>
        <tr>
        ...
        <tr>
      	...
      	<tr>
          	<td colspan="2"><textarea class="required" name="message" id="contact-form-message" cols="150" rows="10" ><?php echo isset($this->message) ? $this->message : ''; ?></textarea></td>
        </tr>
    	<tr>
          	<td colspan="2">
    			<input type="checkbox" name="copy" id="copy"<?php echo (isset($this->copy) && $this->copy) ? ' checked=""' : '' ?> / style="margin:0px;padding:0px"><label for="copy"><span><?php echo JText::_('COM_ALFCONTACT_FORM_COPYTOME') ?></span></label></td>
        </tr>
                <tr>
                    <td></td>
                    <td><button class="search-jeux-bloc">
